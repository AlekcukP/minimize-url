<div class="col-12 col-lg-11 col-xl-9 col-xxl-8 mx-3 mx-sm-auto border-0 bg-transparent">
    <div class="text-center text-sm-start px-2">
        ...
        <p class="text-start">Copy the shortened link and share it in messages, texts, posts, websites and other locations.</p>
    </div>
</div>
    ...
    <div class="container-fluid py-2 px-0">
        <form name="minimizedUrlForm" class="row">
            <div class="col-12 col-sm-9 col-md-9 mb-1 mb-sm-0">
                <input name="url" type="text" class="form-control py-3 w-100" value="<?= $minimized_url; ?>" required>
            </div>
            <div class="col-12 col-sm-3 col-md-3">
                <button name="btn" type="submit" class="btn btn-primary py-3 w-100">Copy URL</button>
            </div>
        </form>
        <div class="row">
        ...
        <div class="row">
            <div class="col-12 col-sm-7 col-md-8 mb-1 mb-sm-0">
                <a href="/url/count/<?= $url_key; ?>" class="btn btn-primary w-100">Total of clicks of your short URL</a>
            </div>
