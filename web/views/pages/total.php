<div class="col-12 col-lg-11 col-xl-9 col-xxl-8 mx-3 mx-sm-auto border-0 bg-transparent">
    <div class="text-center text-sm-start px-2">
        <h2 class="display-5 fw-medium text-secondary-emphasis">Total URL Clicks</h2>
        <p class="text-start">The number of clicks from the shortened URL that redirected the user to the destination page.</p>
    </div>
</div>
...
<div class="container-fluid col-11 col-sm-12 col-lg-11 col-xl-9 col-xxl-8 mx-auto">
    ...
    <div class="row">
        <div class="col-12 col-sm-7 mb-1 mb-sm-0">
            <a href="/url/counter" class="btn btn-primary w-100">Track clicks from another short URL</a>
        </div>
